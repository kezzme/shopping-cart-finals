<?php
    ...
    if(isset($_POST['btnUpdate'])) {
        ...
        // test if all of the array variables are set      
        ...
        <div class="container">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php if(isset($_SESSION['cartItems'])): ?>
                                <?php foreach($_SESSION['cartItems'] as $key => $value): ?>
                                    <?php foreach($value as $size => $quantity): ?>
                                        ...
                                        <tr>
                                            ...
                                            <!-- product price multiply by quantity -->
                                            <td>₱ <?php echo number_format($arrProducts[$key]['price'] * $quantity, 2); ?></td>
                                            
                                            <!-- delete icon button - contains product value -->
                                ...
                                <tr>
                                        <!-- display recomputed total amount -->
                                        <td colspan="2"> </td>
                                        <td><b>Total</b></td>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    <a href="/shopping-cart-finals/Home/" class="btn btn-danger btn-lg btn-block"><i class="fa fa-shopping-bag"></i> Continue Shopping</a>
                </div>
                <?php if(isset($_SESSION['cartItems'])): ?>
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
